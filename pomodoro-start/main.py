...
name = Label(text='Timer', fg=GREEN, bg=YELLOW, font=(FONT_NAME, 40))
name.grid(column=1, row=0)

button_one = Button(text='Start', highlightthickness=0, command=start_timer)
button_one.grid(column=0, row=2)

button_two = Button(text='Reset', highlightthickness=0, command=reset_timer)
